...
database_name = case Padrino.env
  when :development then 'deploy_easy_development'
  when :production  then 'deploy_easy_production'
  when :test        then 'deploy_easy_test'
end
...
#       default:
#         database: deploy_easy_development
#         hosts:
#           - localhost:27017
#
#   production:
#     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
#       default:
#         database: deploy_easy_production
#         hosts:
#           - localhost:27017
#
#   test:
